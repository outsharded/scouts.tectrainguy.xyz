...
import { ArrowCircleUpIcon, LibraryIcon } from "@heroicons/react/outline";
const MailCard = ({ section }) => {
  return (
    <motion.a
      ...
      className="rounded-3xl bg-[#7413dc] dark:saturate-150 dark:brightness-50 flex justify-center items-center col-span-1 relative"
    ...
    >
      <div className="flex items-center w-full justify-center aspect-square">
        <LibraryIcon className="text-white dark:text-gray-900 w-10 md:w-20 lg:w-32 xl:w-1/2" />
      </div>
